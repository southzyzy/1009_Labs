...
class Task1 {
    ...
    public Task1() {
        ...
        switch (year % 12) {
            case 0 -> this.animal = "monkey";
            case 1 -> this.animal = "rooster";
            case 2 -> this.animal = "dog";
            case 3 -> this.animal = "pig";
            case 4 -> this.animal = "rat";
            case 5 -> this.animal = "ox";
            case 6 -> this.animal = "tiger";
            case 7 -> this.animal = "rabbit";
            case 8 -> this.animal = "dragon";
            case 9 -> this.animal = "snake";
            case 10 -> this.animal = "horse";
            case 11 -> this.animal = "sheep";
        }
    }
